    ...
    return (
        <section className="py-16 md:py-36 bg-white overflow-hidden">
            <div className="container mx-auto px-4 sm:px-6 max-w-7xl text-center">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-luxury-black mb-12 md:mb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                    {pillars.map((pillar, idx) => (
                        <div 
                            key={idx} 
                            className="pillar-card-animate p-8 md:p-10 rounded-[1.5rem] md:rounded-[2rem] bg-[#FDFDFB] border border-gray-100 hover:border-gray-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-350 flex flex-col justify-between text-left h-full"
                        >
