        ...
        const handleScroll = () => {
            ...
            for (let i = 0; i < galleryItems.length; i++) {
                if (cardElements[i]) {
                    ...
                    const cardCenterScroll =
                        cardElements[i].offsetLeft -
                        (containerWidth / 2) +
                        (cardWidth / 2);

                    const distance =
                        Math.abs(cardCenterScroll - scrollLeft);
            ...
            <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
                ...
                <div className="text-center md:text-left md:flex justify-between items-end mb-12 md:mb-16 space-y-3 md:space-y-0">
                    ...
                    <p className="text-gray-500 max-w-sm font-light text-sm">
                        A curated look inside our workshop and studio floor,
                        where high precision manufacturing brings artistic concepts to reality.
                    </p>
                </div>
                ...
                <div className="relative w-full">
                    ...
                    <button
                        ...
                        className={`absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-40 w-12 h-12 md:w-14 md:h-14 rounded-full bg-white border border-gray-200 shadow-md hover:-translate-y-[calc(50%+4px)] active:scale-95 transition-all flex items-center justify-center text-luxury-black hover:bg-gray-50 focus:outline-none ${currentIndex === galleryItems.length - 1
                                ? 'opacity-0 pointer-events-none'
                                : 'opacity-100 cursor-pointer'
                            }`}
