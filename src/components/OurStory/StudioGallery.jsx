    ...
    return (
        <section className="py-24 md:py-36 bg-[#FAF9F6] border-y border-gray-100/50 overflow-hidden">
            <div className="container mx-auto px-6 max-w-7xl">
                ...
                {/* Header Section */}
                <div className="text-center md:text-left md:flex justify-between items-end mb-16 space-y-4 md:space-y-0">
                    <div>
                ...
                <div className="relative w-full">
                    ...
                    <button
                        ...
                        className={`absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-40 w-12 h-12 md:w-14 md:h-14 rounded-full bg-white border border-gray-200 shadow-md hover:-translate-y-[calc(50%+4px)] active:scale-95 transition-all flex items-center justify-center text-luxury-black hover:bg-gray-50 focus:outline-none ${
                    ...
                    <button
                        ...
                        className={`absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-40 w-12 h-12 md:w-14 md:h-14 rounded-full bg-white border border-gray-200 shadow-md hover:-translate-y-[calc(50%+4px)] active:scale-95 transition-all flex items-center justify-center text-luxury-black hover:bg-gray-50 focus:outline-none ${
                            currentIndex === galleryItems.length - 1 ? 'opacity-0 pointer-events-none' : 'opacity-100 cursor-pointer'
                        }`}
                        style={{ transition: 'all 0.4s ease' }}
                    ...
                    <div 
                        ...
                        className="flex gap-8 md:gap-12 px-6 md:px-[35vw] items-center h-[520px] overflow-x-auto md:overflow-x-hidden scrollbar-none snap-x snap-mandatory md:snap-none"
                    >
