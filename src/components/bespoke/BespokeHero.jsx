    ...
    return (
        <section ref={heroRef} className="relative h-[80vh] md:h-screen min-h-[450px] md:min-h-[100svh] w-full flex flex-col justify-center items-center overflow-hidden border-b border-gray-100 bg-white pt-24 md:pt-28 pb-16 md:pb-24">
            ...
            <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto flex flex-col items-center">
                ...
                <h1 className="hero-animate text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-serif text-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.65)] tracking-tight leading-[1.05] mb-6 md:mb-8">
                    Bespoke <br />
                ...
                <p className="hero-animate text-sm sm:text-base md:text-lg text-white/90 font-medium max-w-xl mx-auto leading-relaxed mb-8 md:mb-10 tracking-wide drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
